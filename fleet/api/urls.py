...
urlpatterns = [
    ...
    url(r'^operation_list/(?P<pk>[0-9]+)/$$', operation_detail),
    url(r'^feed_list/$', feed_list),
    url(r'^feed_list/(?P<pk>[0-9]+)/$$', feed_detail),
    url(r'^vehicle_list/$', vehicle_list),
    url(r'^vehicle_list/(?P<pk>[0-9]+)/$$', vehicle_detail),
]
